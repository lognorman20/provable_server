import { IField } from '@scure/starknet/node_modules/@noble/curves/abstract/modular';
import { poseidon } from '@scure/starknet/node_modules/@noble/curves/abstract/poseidon';
import { ProjPointType, SignatureType } from '@scure/starknet/node_modules/@noble/curves/abstract/weierstrass';
import * as u from '@scure/starknet/node_modules/@noble/curves/abstract/utils';
import type { Hex } from '@scure/starknet/node_modules/@noble/curves/abstract/utils';
type ProjectivePoint = ProjPointType<bigint>;
export declare const MAX_VALUE: bigint;
export declare const _starkCurve: import("@scure/starknet/node_modules/@noble/curves/abstract/weierstrass").CurveFn;
...
declare const CURVE: Readonly<{
    ...
    readonly isTorsionFree?: ((c: import("@scure/starknet/node_modules/@noble/curves/abstract/weierstrass").ProjConstructor<bigint>, point: ProjPointType<bigint>) => boolean) | undefined;
    readonly clearCofactor?: ((c: import("@scure/starknet/node_modules/@noble/curves/abstract/weierstrass").ProjConstructor<bigint>, point: ProjPointType<bigint>) => ProjPointType<bigint>) | undefined;
    ...
    readonly p: bigint;
}>, ProjectivePoint: import("@scure/starknet/node_modules/@noble/curves/abstract/weierstrass").ProjConstructor<bigint>, Signature: import("@scure/starknet/node_modules/@noble/curves/abstract/weierstrass").SignatureConstructor, utils: {
